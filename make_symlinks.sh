...
ln -s ${PWD}/run_AM_sme_F.sh /scratch/work/jpleino1/kaldi-trunk/egs/sme_F/run.sh

ln -s ${PWD}/cmd_AM_sme_F.sh /scratch/work/jpleino1/kaldi-trunk/egs/sme_LMs/cmd.sh
ln -s ${PWD}/path_AM_sme_F.sh /scratch/work/jpleino1/kaldi-trunk/egs/sme_LMs/path.sh
ln -s ${PWD}/run_LM_sme_LMs.sh /scratch/work/jpleino1/kaldi-trunk/egs/sme_LMs/run.sh
